...
function proxiedFetch(url, ...args) {
    ...
    return fetch(proxiedUrl, Object.assign({ method: 'GET', cache: 'no-cache' }, args)).then((response) => __awaiter(this, void 0, void 0, function* () {
        if (!response.ok) {
        ...
        try {
            ...
            const fallbackRes1 = yield fetch(fallbackUrl1, ...args);
            if (fallbackRes1.ok) {
                const data = yield fallbackRes1.json();
                return {
                    ok: true,
        ...
        try {
            ...
            const fallbackRes2 = yield fetch(fallbackUrl2, ...args);
            if (fallbackRes2.ok) {
                const text = yield fallbackRes2.text();
                return {
                    ok: true,
                    text: () => Promise.resolve(text),
                    json: () => Promise.resolve(JSON.parse(text))
...
function parseYoutubeRssEntry(entry) {
    ...
    if (videoIdElem) {
        ...
        if (idElem) {
            const idText = ((_e = idElem.textContent) === null || _e === void 0 ? void 0 : _e.trim()) || '';
...
class YoutubeRssApi {
    ...
    extractChannelIdFromHtml(url) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const res = yield proxiedFetch(url);
                if (!res.ok)
                    return null;
    ...
    getChannelName(channelId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const res = yield proxiedFetch(feedUrl);
                if (!res.ok)
                    return null;
    ...
    getLiveStatus(videoId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const res = yield proxiedFetch(videoUrl);
                if (!res.ok)
